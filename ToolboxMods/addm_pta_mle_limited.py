...
def main(rangeD, rangeSigma, rangeTheta, trialsFileName=None,
    ...
    # PS mods begin
    print (u"PS modification to avoid calculating simulations. To undo, please uncomment last section at /Users/bdmlab/anaconda3/lib/python3.6/site-packages/addm_toolbox/addm_pta_mle.py")
